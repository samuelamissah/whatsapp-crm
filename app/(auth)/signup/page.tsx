...
export default function SignupPage() {
  ...
  async function handleSignup(e: React.FormEvent) {
    ...
    if (!data.session) {
      setLoading(false);
      setErrorMessage("Signup successful! Please check your email to confirm your account before logging in to create your workspace.");
      return;
    }

    // If session is present, they are automatically logged in.
      ...
      <div className="w-full max-w-md rounded-3xl border bg-white p-8 shadow-sm">
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500">Start managing your WhatsApp sales.</p>
          </div>
        </div>
