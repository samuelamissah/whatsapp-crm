    ...
    <main className="min-h-screen bg-[#f7f8f4] text-slate-950">
      ...
      <section className="mx-auto grid min-h-[calc(100vh-88px)] max-w-6xl items-center gap-12 px-6 pb-16 lg:grid-cols-[1fr_440px]">
        ...
        >
          ...
          <h1 className="max-w-2xl text-5xl font-bold tracking-[-0.04em] text-slate-950 leading-[1.05]">
            Pick up from where your last customer left off.
          </h1>

          <p className="mt-6 max-w-xl text-lg leading-8 text-slate-600">
            Sign in to see today&apos;s customers, pending payments, recent
            orders, and follow-ups without scrolling through endless WhatsApp
            chats.
          </p>
          ...
          <div className="mt-8 grid max-w-xl gap-3">
            <InfoItem
              ...
              text="Open customer chats from their profile when it is time to follow up."
            />
            <InfoItem
              icon={ShoppingBag}
              title="Track orders clearly"
              text="See what is pending, paid, delivered, or cancelled."
            />
            <InfoItem
              icon={ShieldCheck}
              title="Private workspace"
              text="Your customers and orders stay inside your own business account."
            />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative rounded-[2rem] border border-slate-200 bg-white p-8 shadow-xl">
            <div className="mb-8">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-500">
                Manage your WhatsApp customers, orders, and follow-ups.
              </p>
            </div>
          ...
          <div className="mt-5 flex items-center justify-center gap-2 text-xs text-slate-500">
            ...
            Secure login for seller workspaces
          </div>
        </motion.div>
      </section>
    </main>
